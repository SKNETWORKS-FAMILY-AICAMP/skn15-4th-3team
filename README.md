...
보험사의 약관은 매년 더 복잡해지고 길어지며, 가입자들에게는 가볍게 읽기 어려운 문서가 되어가고 있습니다. 이 프로젝트는 바로 그 문제에서 출발했습니다.
...
* 기현택 : 조용한 스타일의 팀장임에도 다들 너무 잘 해주셔서 감사합니다. 발표 준비를 하면서 RAG와 LLM에 대해 많은 것을 공부할 수 있었던 뜻깊은 시간이었습니다.
