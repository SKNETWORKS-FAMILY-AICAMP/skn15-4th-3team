 ...
 * 간편 질문 : 나이, 성별, 차종을 간단하게 입력 -> 빠른 보험 추천
   
 * 상세 질문 : 구체적 상황 질의 -> 약관 기반 답변 제공
   
 * 이력 관리 : 질문과 답변이 저장 -> 이전 대화 열람

 * 새로운 채팅 : 새로운 탭을 통한 채팅 가능
...
### 2. 저장소 클론
```bash
git clone https://github.com/SKNETWORKS-FAMILY-AICAMP/skn15-4th-3team.git
cd skn15-4th-3team
```
